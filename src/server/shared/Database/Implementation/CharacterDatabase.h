...
{
    public:
        CharacterDatabaseConnection(MySQLConnectionInfo& connInfo, ConnectionFlags index)
...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_GUILD_MEMBER_REPUTATION,
    CHAR_REP_GUILD_MEMBER_REPUTATION,
    CHAR_DEL_GUILD_MEMBER_REPUTATION,
    ...
    CHAR_INS_GUILD_NEWS,
    CHAR_UPD_GUILD_MEMBER_PROFESSIONS,
    CHAR_UPD_GUILD_MEMBER_ACHIEVEMENTS,
    CHAR_REP_GUILD_CHALLENGE,
    ...
    CHAR_INS_RATED_PVP_INFO,
    CHAR_UPD_RATED_PVP_INFO,
    CHAR_UPD_ALL_RATED_PVP_INFO_LAST_WEEK,
    CHAR_UPD_ALL_RATED_PVP_INFO_WEEKLY,
    ...
    CHAR_SEL_ACCOUNT_ACHIEVEMENT,
    CHAR_SEL_ACCOUNT_ACHIEVEMENT_PROGRESS,
    CHAR_REP_ACCOUNT_ACHIEVEMENT,
    CHAR_REP_ACCOUNT_ACHIEVEMENT_PROGRESS,
    ...
    CHAR_SEL_CHAR_INVENTORY_BOOST,
    CHAR_DEL_CHAR_INVENTORY_BOOST,
    CHAR_SEL_CHAR_HEARTHSTONE_BOOST,
    CHAR_UPD_CHAR_HEARTHSTONE_BOOST,
    CHAR_SEL_CHAR_TALENT,
    CHAR_SEL_CHAR_SPELL,
    CHAR_SEL_CHARACTER_SKILL_BOOST,
    CHAR_SEL_CHARACTER_SKILLS_BOOST,
    CHAR_INS_CHAR_INVENTORY,
    CHAR_UPD_CHARACTER_FOR_BOOST,
    ...
    CHAR_SEL_DESERTER_INFO,
    CHAR_REP_DESERTER_INFO,
    CHAR_DEL_DESERTER_INFO,

    CHAR_SEL_BATTLEGROUND_STATS,
    CHAR_REP_BATTLEGROUND_STATS,
    CHAR_DEL_BATTLEGROUND_STATS,
