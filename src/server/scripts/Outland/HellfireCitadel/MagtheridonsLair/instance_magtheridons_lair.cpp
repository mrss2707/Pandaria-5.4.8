    ...
    public:
        ...
        struct instance_magtheridons_lair_InstanceMapScript : public InstanceScript
        {
            ...
            void Initialize() override
            {
                ...
                MagtheridonGUID = ObjectGuid::Empty;
                ChannelerGUID.clear();
            ...
            void SetData(uint32 type, uint32 data) override
            {
                ...
                case DATA_CHANNELER_EVENT:
                    ...
                    case NOT_STARTED: // Reset all channelers once one is reset.
                        if (m_auiEncounter[1] != NOT_STARTED)
                        {
                            ...
                            for (std::set<ObjectGuid>::const_iterator i = ChannelerGUID.begin(); i != ChannelerGUID.end(); ++i)
                            {
                ...
                case DATA_COLLAPSE:
                    ...
                    for (std::set<ObjectGuid>::const_iterator i = ColumnGUID.begin(); i != ColumnGUID.end(); ++i)
                        DoUseDoorOrButton(*i);
                    break;
                default:
                    break;
