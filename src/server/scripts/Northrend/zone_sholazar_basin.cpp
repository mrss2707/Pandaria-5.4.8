        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            switch (waypointId)
            {
                ...
                case 1:
                    ...
                    me->SummonGameObject(184743, 5918.33f, 5372.91f, -98.770f, 0, { }, TEMPSUMMON_MANUAL_DESPAWN);     //approx 3 to 4 seconds
                ...
                case 8:
                    ...
                    me->SummonGameObject(184743, 5887.37f, 5379.39f, -91.289f, 0, { }, TEMPSUMMON_MANUAL_DESPAWN);      //approx 3 to 4 seconds
                    me->HandleEmoteCommand(EMOTE_ONESHOT_LAUGH);
                    break;
                case 9:
                    Talk(SAY_WP_6);
