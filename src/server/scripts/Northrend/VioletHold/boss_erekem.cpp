    ...
    public:
        ...
        struct boss_erekemAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                if (Creature* pGuard1 = Unit::GetCreature(*me, instance ? instance->GetGuidData(DATA_EREKEM_GUARD_1) : 0))
                {
                    if (!pGuard1->IsAlive())
                        pGuard1->Respawn();
                }
                if (Creature* pGuard2 = Unit::GetCreature(*me, instance ? instance->GetGuidData(DATA_EREKEM_GUARD_2) : 0))
                {
                    if (!pGuard2->IsAlive())
                        pGuard2->Respawn();
                }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                if (uiChainHealTimer <= diff)
                {
                    if (uint64 TargetGUID = GetChainHealTargetGUID())
                    {
                        ...
                        Creature* pGuard1 = Unit::GetCreature(*me, instance ? instance->GetGuidData(DATA_EREKEM_GUARD_1) : 0);
                        Creature* pGuard2 = Unit::GetCreature(*me, instance ? instance->GetGuidData(DATA_EREKEM_GUARD_2) : 0);
