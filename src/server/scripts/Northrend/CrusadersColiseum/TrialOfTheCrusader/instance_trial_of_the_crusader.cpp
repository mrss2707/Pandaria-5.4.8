    ...
    public:
        ...
        struct instance_trial_of_the_crusader_InstanceMapScript : public InstanceScript
        {
            ...
            void Initialize() override
            {
                ...
                TirionFordringGUID = ObjectGuid::Empty;
                BarrentGUID = ObjectGuid::Empty;
                TirionGUID = ObjectGuid::Empty;
                FizzlebangGUID = ObjectGuid::Empty;
                GarroshGUID = ObjectGuid::Empty;
                VarianGUID = ObjectGuid::Empty;
                GormokGUID = ObjectGuid::Empty;
                AcidmawGUID = ObjectGuid::Empty;
                DreadscaleGUID = ObjectGuid::Empty;
                IcehowlGUID = ObjectGuid::Empty;
                JaraxxusGUID = ObjectGuid::Empty;
                ChampionsControllerGUID = ObjectGuid::Empty;
                DarkbaneGUID = ObjectGuid::Empty;
                LightbaneGUID = ObjectGuid::Empty;
                AnubarakGUID = ObjectGuid::Empty;

                TributeChestGUID = ObjectGuid::Empty;
                MainGateDoorGUID = ObjectGuid::Empty;
                EastPortcullisGUID = ObjectGuid::Empty;
                WebDoorGUID = ObjectGuid::Empty;
                CrusadersCacheGUID = ObjectGuid::Empty;
                FloorGUID = ObjectGuid::Empty;
            }
                            ...
                            case DONE:
                            {
                                ...
                                if (tributeChest)
                                    if (Creature* tirion =  instance->GetCreature(TirionGUID))
                                        if (GameObject* chest = tirion->SummonGameObject(tributeChest, 805.62f, 134.87f, 142.16f, 3.27f, { }, WEEK))
                ...
                switch (type)
                {
                    ...
                    case DATA_SNOBOLD_COUNT:
                        if (data == INCREASE)
                        {
                            ...
                            uint32 required = instance->Is25ManRaid() ? 4 : 2;
                            if (SnoboldCount >= required)
                                instance->SetWorldState(instance->Is25ManRaid() ? WORLDSTATE_UPPER_BACK_PAIN_25 : WORLDSTATE_UPPER_BACK_PAIN_10, 1);
                        }
                        else if (data == DECREASE)
                        {
                            ...
                            uint32 required = instance->Is25ManRaid() ? 4 : 2;
                            if (SnoboldCount < required)
                                instance->SetWorldState(instance->Is25ManRaid() ? WORLDSTATE_UPPER_BACK_PAIN_25 : WORLDSTATE_UPPER_BACK_PAIN_10, 0);
                        }
                        break;
                    case DATA_MISTRESS_OF_PAIN_COUNT:
                        if (data == INCREASE)
                        {
                            ...
                            if (MistressOfPainCount >= 2)
                                instance->SetWorldState(instance->Is25ManRaid() ? WORLDSTATE_THREE_SIXTY_PAIN_25 : WORLDSTATE_THREE_SIXTY_PAIN_10, 1);
                        }
                        else if (data == DECREASE)
                        {
                            --MistressOfPainCount;
                            ...
                            if (MistressOfPainCount < 2)
                                instance->SetWorldState(instance->Is25ManRaid() ? WORLDSTATE_THREE_SIXTY_PAIN_25 : WORLDSTATE_THREE_SIXTY_PAIN_10, 0);
                        }
                        break;
