...
DELETE FROM `spell_script_names` WHERE `ScriptName`='spell_mage_arcane_brilliance';
DELETE FROM `spell_script_names` WHERE `ScriptName`='spell_mage_dalaran_brilliance';